  ...
  return (
    <section className="w-[1920px] h-[931px] flex">
      <div className="w-[50%] h-full flex items-center justify-center text-right ">
        <div className="w-[533px] h-[603px]">
          ...
          <div className="flex items-center justify-between my-[20px]">
            ...
            <button
              onClick={() => navigate("/")}
              className="w-[140px] h-[51px] p-[16px] text-[16px] text-white bg-mainColor mb-[10px] font-bold flex items-center justify-center rounded-lg hover:bg-[#1877F2] transition-all duration-300"
            >
              تسجيل الدخول
            </button>
          </div>
      ...
      <div className="w-[50%] h-full relative">
        <img src="assets/login.jpg" alt="login" className="w-full h-full" />
        <div className="flex flex-col absolute top-[50%] translate-y-[-50%] left-0">
          <button className="w-[140px] h-[51px] rounded-tr-[30px] rounded-br-[30px] p-[16px] text-[16px] text-white bg-mainColor mb-[10px] font-bold flex items-center hover:bg-[#1877F2] transition-all duration-300">
            تسجيل الدخول
          </button>
          <button
            onClick={() => navigate("/signup")}
            className="w-[140px] h-[51px] rounded-tr-[30px] rounded-br-[30px] p-[16px] text-[16px] text-black bg-white font-bold flex items-center hover:bg-[#1877F2] hover:text-white transition-all duration-300"
          >
            انشاء حساب
          </button>
        </div>
